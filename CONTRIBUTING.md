# Contributing to GrandelGradenNexus 🚀

First of all, thank you for being here! We are building the fastest, most efficient native desktop interface for Ollama,
and your help is vital to making GrandelGradenNexus a greta project of Open Source Software.
...
Clone your fork: git clone https://github.com/YOUR_USER/GrandelGradenNexus.git
...
## ⚖️ License
By contributing to GrandelGradenNexus, you agree that your contributions will be licensed under the project's Apache License 2.0 (or the license you chose).

...
public class AboutController implements Initializable {
    ...
    private void openGitHub() {
        openLink("https://github.com/gradenmodels/GradenModels");
    }
    ...
    private void openBuyMeCoffee() {
        openLink("https://buymeacoffee.com/gradenmodels");
    }

    @FXML
    private void openGitHubContribute() {
        openLink("https://github.com/gradenmodels/GradenModels/issues");
    }

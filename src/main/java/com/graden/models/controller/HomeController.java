...
public class HomeController implements Initializable {
    ...
    private void checkPendingUpdates() {
        ...
        UpdateManagerService updateManager = new UpdateManagerService();
        java.nio.file.Path newJarPath = java.nio.file.Paths.get(updateManager.getNewDir(), "lib", "GrandelGradenNexus.jar");
        java.nio.file.Path currentJarPath = java.nio.file.Paths.get(updateManager.getAppRoot(), "lib", "GrandelGradenNexus.jar");

...
public class UpdateManagerService {
    ...
    private String determineAppRoot() {
        try {
            ...
            // Expected structure is <Root>/lib/GrandelGradenNexus.jar
     ...
     * Note: The GitHub distribution ZIP contains a root folder (e.g., `GrandelGradenNexus-0.6.0-Dist`).
            ...
            while (zipEntry != null) {
                ...
                if (rootFolderName == null) {
                    ...
                    if (firstSlash != -1) {
                        ...
                        if (potentialRoot.toLowerCase().contains("GrandelGradenNexus")) {
    ...
    public void backupCurrentVersion() throws IOException {
        ...
        String[] filesToBackup = {
            "GrandelGradenNexus", "GrandelGradenNexus.bat", "GrandelGradenNexus.command", "GrandelGradenNexus.sh"
        };

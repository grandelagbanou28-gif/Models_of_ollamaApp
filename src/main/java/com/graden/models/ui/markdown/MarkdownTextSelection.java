...
public final class MarkdownTextSelection {
    ...
    private static final String INSTANCE_KEY = "GrandelGradenNexus.markdown-text-selection";
    private static final String SHAPE_KEY = "GrandelGradenNexus.markdown-selection-shape";
    private static final String SCENE_FILTER_KEY = "GrandelGradenNexus.markdown-key-filter";
